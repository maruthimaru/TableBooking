...
public class SeatSelectionRound extends AppCompatActivity {
    ...
    String time;
    String seats;
    private String TAG= SeatSelectionRound.class.getSimpleName();
...
//                    toast.show();
    ...
    public void seat_information(View V){
        ...
        if(seats_counter!= 0){
            ...
            intent = new Intent(SeatSelectionRound.this,Confirmation.class);
