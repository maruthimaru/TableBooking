...
class SeatSelection : AppCompatActivity() {
    ...
    private val TAG = SeatSelection::class.java.simpleName
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (theatre.equals("The Saravana bavan")){
            menuItemModelArrayList.add(MenuItemModel("cucumber water", R.drawable.cucumber_water))
            menuItemModelArrayList.add(MenuItemModel("ice cream cone", R.drawable.ice_cream_cone))
            menuItemModelArrayList.add(MenuItemModel("avocado toast", R.drawable.avocado_toast))
            menuItemModelArrayList.add(MenuItemModel("bacon and eggs breakfast", R.drawable.bacon_and_eggs_breakfast))
            menuItemModelArrayList.add(MenuItemModel("berry cheesecake", R.drawable.berry_cheesecake))
            menuItemModelArrayList.add(MenuItemModel("breakfast from above", R.drawable.breakfast_from_above))
            menuItemModelArrayList.add(MenuItemModel("croissant coffee", R.drawable.croissant_coffee))
            menuItemModelArrayList.add(MenuItemModel("curry bowl garnished with greens", R.drawable.curry_bowl_garnished_with_greens))
        }
        if (theatre.equals("Radisson blu")){
            menuItemModelArrayList.add(MenuItemModel("chocolate_cake", R.drawable.chocolate_cake_with_toffee_sauced_drizzled_over))
            menuItemModelArrayList.add(MenuItemModel("dinner salad", R.drawable.dinner_salad))
            menuItemModelArrayList.add(MenuItemModel("flame broiled steak", R.drawable.flame_broiled_steak))
            menuItemModelArrayList.add(MenuItemModel("fresh appetizers cocktails", R.drawable.fresh_appetizers_cocktails))
            menuItemModelArrayList.add(MenuItemModel("fresh plated salad", R.drawable.fresh_plated_salad))
            menuItemModelArrayList.add(MenuItemModel("cucumber water", R.drawable.cucumber_water))
            menuItemModelArrayList.add(MenuItemModel("green apples", R.drawable.green_apples))
            menuItemModelArrayList.add(MenuItemModel("healthy breakfast", R.drawable.healthy_breakfast))
        }
        if (theatre.equals("Holiday residency")){
            menuItemModelArrayList.add(MenuItemModel("ice cream cone", R.drawable.ice_cream_cone))
            menuItemModelArrayList.add(MenuItemModel("indian food on restaurant table", R.drawable.indian_food_on_restaurant_table))
            menuItemModelArrayList.add(MenuItemModel("milkshake on pink", R.drawable.milkshake_on_pink))
            menuItemModelArrayList.add(MenuItemModel("chocolate cake with toffee", R.drawable.chocolate_cake_with_toffee_sauced_drizzled_over))
            menuItemModelArrayList.add(MenuItemModel("plated smoked salmon", R.drawable.plated_smoked_salmon))
            menuItemModelArrayList.add(MenuItemModel("popcicle", R.drawable.popcicle))
            menuItemModelArrayList.add(MenuItemModel("restaurant breakfast", R.drawable.restaurant_breakfast))
            menuItemModelArrayList.add(MenuItemModel("root vegetable salad", R.drawable.root_vegetable_salad))
        }
        if (theatre.equals("Plaza inn")){
            menuItemModelArrayList.add(MenuItemModel("salad with chicken", R.drawable.salad_with_chicken))
            menuItemModelArrayList.add(MenuItemModel("shrimp lunch dish", R.drawable.shrimp_lunch_dish))
            menuItemModelArrayList.add(MenuItemModel("summer cocktials", R.drawable.summer_cocktials))
            menuItemModelArrayList.add(MenuItemModel("sushi", R.drawable.sushi))
            menuItemModelArrayList.add(MenuItemModel("toast eggs for breakfast", R.drawable.toast_eggs_for_breakfast))
            menuItemModelArrayList.add(MenuItemModel("waffles and fruit breakfast", R.drawable.waffles_and_fruit_breakfast))
            menuItemModelArrayList.add(MenuItemModel("avocado toast", R.drawable.avocado_toast))
            menuItemModelArrayList.add(MenuItemModel("berry cheesecake", R.drawable.berry_cheesecake))
        }
        ...
        if (theatre.equals("Lemon tree")){
            ...
            menuItemModelArrayList.add(MenuItemModel("shrimp lunch dish", R.drawable.shrimp_lunch_dish))
            menuItemModelArrayList.add(MenuItemModel("avocado toast", R.drawable.avocado_toast))
            menuItemModelArrayList.add(MenuItemModel("Dosa", R.drawable.cucumber_water))
        }
//
//        menuItemModelArrayList.add(MenuItemModel("Chicken briyani", R.drawable.chicken_biryani_recipe))
//        menuItemModelArrayList.add(MenuItemModel("Egg fride rice", R.drawable.egg_fried_rice))
...
//        alertDialog = customDialog.loading(activity!!)
            ...
            override fun onResponse(call: Call<SeatDetailResponse>, response: retrofit2.Response<SeatDetailResponse>) {
                ...
                if (response.body() != null) {
                    if (response.body()!!.status!!) {
                        val jsArray = JSONArray(response.body()!!.data);
    ...
    fun seat_information(V: View?) {
        ...
        if (seats_counter != 0) {
            ...
            intent = Intent(this@SeatSelection, Confirmation::class.java)
